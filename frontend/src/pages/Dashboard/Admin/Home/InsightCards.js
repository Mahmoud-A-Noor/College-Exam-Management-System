...
export default function InsightCards({adminInsights}){
    return (
                    ...
                    <div id="students-card" className='insight-card'>
                        <div className="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4>+{adminInsights.students_count}</h4>
                            </div>
                            <div>
                    ...
                    <div id="lecturer-card" className='insight-card'>
                        <div className="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4>+{adminInsights.lecturers_count}</h4>
                            </div>
                            <div>
                ...
                <div className="col-lg-3 col-md-6 col-xs-12">
                    <div id="subject-card" className='insight-card'>
                        <div className="d-flex align-items-center justify-content-between">
                            <div>
                                <h5>Course</h5>
                                <h4>+{adminInsights.courses_count}</h4>
                            </div>
                            <div>
                    ...
                    <div id="exam-card" className='insight-card'>
                        <div className="d-flex align-items-center justify-content-between">
                            <div className='d-flex flex-column align-items-center'>
                                <h5>Exam</h5>
                                <h4>+{adminInsights.exams_count}</h4>
                            </div>
                            <div>
